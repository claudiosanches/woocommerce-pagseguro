...
<a class="button cancel" href="<?php echo esc_url( $order->get_cancel_order_url() ); ?>"><?php _e( 'Cancel order &amp; restore cart', 'woocommerce-pagseguro' ); ?></a> <a id="submit-payment" class="button alt" href="<?php esc_url_raw( $response['url'] ); ?>"><?php _e( 'Pay via PagSeguro', 'woocommerce-pagseguro' ); ?></a>
