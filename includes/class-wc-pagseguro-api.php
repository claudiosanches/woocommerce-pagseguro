...
class WC_PagSeguro_API {
	...
	protected function safe_load_xml( $source, $options = 0 ) {
		...
		if ( function_exists( 'libxml_disable_entity_loader' ) ) {
			$old = @libxml_disable_entity_loader( true ); // phpcs:ignore Generic.PHP.DeprecatedFunctions.Deprecated, WordPress.PHP.NoSilencedErrors.Discouraged
		}
		...
		if ( ! is_null( $old ) ) {
			@libxml_disable_entity_loader( $old ); // phpcs:ignore Generic.PHP.DeprecatedFunctions.Deprecated, WordPress.PHP.NoSilencedErrors.Discouraged
		}
