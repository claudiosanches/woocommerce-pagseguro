...
if ( apply_filters( 'woocommerce_pagseguro_help_message', true ) ) : ?>
	<div class="updated inline woocommerce-message">
		<p>
			<?php
				/* translators: 1: plugin name, 2: stars */
				echo esc_html( sprintf( __( 'Help us keep the %1$s plugin free making a donation or rate %2$s on WordPress.org. Thank you in advance!', 'woocommerce-pagseguro' ), __( 'Claudio Sanches - PagSeguro for WooCommerce', 'woocommerce-pagseguro' ), '&#9733;&#9733;&#9733;&#9733;&#9733;' ) );
			?>
		</p>
